"""The purpose of this script is to ensure that our sales table
is clean and ready for down stream analysis. This script will perform the following tasks:
1. Remove any duplicate records from the sales table.
2. Address any missing values in the sales table.
3. Ensure that the data types of each column are appropriate for analysis.
4. Address any issues related with outliers in the sales table.
5. Standardize the format of the data in the sales table.
"""
...
def standardize_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    if "saleDate" in df.columns:
        ...
        LOG.info("Converted 'saleDate' to datetime.")
